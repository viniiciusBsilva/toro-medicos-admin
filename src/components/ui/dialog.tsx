...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {showClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md text-text-secondary hover:text-text-primary">
          <X className="h-5 w-5" />
...
export { Dialog, DialogPortal, DialogOverlay, DialogTrigger, DialogClose, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter };
